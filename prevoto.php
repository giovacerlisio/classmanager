...
<body>
<div class="container">
      <form method="POST" action="voto.php" autocomplete="on">
      ...
      <img src="gear-5384557_1280.png" alt="Logo Form" width="70" height="70">
    		...
    		<div class="box">
          <label for="assegno" class="fl fontLabel"> Voto: </label>
        ...
        <div class="box">
          ...
          <label for="username" class="fl fontLabel"> Username: </label>
    			...
    			<div class="fr">
    					<input type="text" name="username" placeholder="Username Alunno"
              class="textBox" autofocus="on" required>
    			</div>
    			<div class="clr"></div>
    		</div>
